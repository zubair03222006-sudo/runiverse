...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "GPS running game for India. Claim streets, defend territory, level up like a Sher." },
      { property: "og:title", content: "Terra Run — Capture Your City" },
      { property: "og:description", content: "GPS running game for India. Claim streets, defend territory, level up like a Sher." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Terra Run — Capture Your City" },
      { name: "twitter:description", content: "GPS running game for India. Claim streets, defend territory, level up like a Sher." },
